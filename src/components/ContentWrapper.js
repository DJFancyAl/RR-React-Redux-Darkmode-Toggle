...
function ContentWrapper() {
    ...
    const containerStyle = {backgroundColor:theme.color3}
    ...
    return (
        <div className="ContentWrapper" style={containerStyle}>
            <div style={theme.darkMode ? darkStyle : lightStyle}>
